...
| security-packs (doctrine + tools/scanners stub) | ✅ MVP fait |
| ai-privacy-gateway (policy yaml + scaffold) | ✅ Scaffold (Presidio à brancher phase 1) |
| backend-packs (README + supabase-trigger pack.yaml) | ✅ Scaffold |
| factory-control-center (DB schema) | ✅ Schéma fait, UI à coder phase 4 |
| finance-ledger (schémas + policies) | ✅ MVP fait |
| ops-autopilot (status schema + action policy) | ✅ Schéma fait, code phase 4 |
| ops-packs / automation-packs / context-engine / dev-orchestrator | 🟡 Scaffold (READMEs + structure) |
| repo-factory-shell / reference-site-analyzer / feature-generation / modules-registry | 🟡 Scaffold (à coder phase 1-2) |
